...
<form method="POST" enctype="multipart/form-data" id="form1" action="uploadExcel/form">
    ...
    <br>
    <input id="upfile" type="file" class="layui-btn layui-btn-normal
    layui-btn-sm layui-icon layui-icon-release" name="upfile"><br> <br>

                 <input type="button" class="layui-btn layui-btn-normal
    layui-btn-sm layui-icon layui-icon-release"  value="确定" id="btn" name="btn">
